...
<?php include("../includes/nav.html"); ?>
		...
		<div class="inner">
			...
			<div class="title centre">
				<h1><b>SEO. Am I taking crazy pills this is a really long title example here</b></h1>
			</div>		
		        
	    <div class="row">
	    
		    <div class="third lede">
				...
				<div class="meta">
					<p>Published on September 9th, 2011<br>
					Filed under <b>Google</b> | <b>SEO</b> | <b>Social Media</b>.</p>
				</div>

		    </div>

		    <article class="two-thirds last">
		    	<h3>I’m currently attending the Brighton SEO conference at the Corn Exchange. Huge turnout, and clearly this industry continues to thrive.</h3>		    
				...
				<p>Some of our clients’ sites have Our main site has still not recovered from Panda, 4 months later.</p>
				...
				<p>As for that quote above… doesn’t the fact the speaker’s clients site(s) were still affected by Panda directly implicate them as an agency that doesn’t provide the necessary best practices, guidelines and quality content that Google and other search engines want to see?</p>
				
				<p>As outlined in the comments below, the speaker worked in-house exclusively. As a result, any opinion on any client sites has been redacted.</p>
